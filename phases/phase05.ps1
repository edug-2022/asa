function InstallDHCP {
    ...
    Add-DhcpServerv4Scope -Name "semita-DHCP" -StartRange 172.16.0.100 -EndRange 172.16.0.200 -SubnetMask 255.255.255.0 -State Active -ErrorAction Stop
    Set-DhcpServerv4OptionValue -ScopeId 172.16.0.0 -Router 172.16.0.2 -ErrorAction Stop
